...
const SKILLS = [
  { name: "Figma & UI/UX", level: 88, color: "#A259FF" },
  { name: "React / Next.js", level: 75, color: "#3B82F6" },
  { name: "Tailwind CSS", level: 80, color: "#06B6D4" },
  { name: "Laravel", level: 85, color: "#F55247" },
...
const EXPERIENCES = [
  ...
  {
    role: "Kepala Staf & Koordinator Acara",
    company: "Himpunan Mahasiswa Teknologi Informasi POLINEMA",
    period: "Agu 2022 – Mar 2024",
    desc: "Memimpin open recruitment, menyelenggarakan program kerja jurusan, dan meningkatkan anggota baru HMTI sebesar 100% pada tahun 2023.",
    color: "#8B5CF6",
  },
  {
    ...
    desc: "Merancang UI/UX POS & e-commerce dengan Figma, membangun dashboard visualisasi data (Power BI, Google Data Studio), serta mengembangkan sistem informasi perpustakaan dengan PHP & Laravel.",
    color: "#10B981",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        />
        <div
          className="absolute top-[50%] right-[-10%] w-[35vw] h-[35vw] rounded-full"
          style={{
            background:
        ...
        />
        <div
          className="absolute bottom-[-5%] left-[30%] w-[30vw] h-[30vw] rounded-full"
          style={{
            background:
...
<nav
  ...
  style={{ background: t.navBg, backdropFilter: "blur(20px)", borderBottom: `1px solid ${t.border}` }}
>
  <div className="mx-auto px-6 md:px-14 py-3.5 flex justify-between items-center max-w-6xl">
    ...
    >
      ...
      <span className="font-bold text-[15px] tracking-tight" style={{ color: t.text }}>RyoDra</span>
    </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <p
              ...
              style={{ color: t.textSub }}
            >
              1+ tahun membangun website modern & produk digital yang memadukan
              estetika dan performa tinggi — dari desain Figma hingga kode
              production.
            </p>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          <div data-aos="fade-right">
            ...
            <p
              ...
              style={{ color: t.textSub }}
            >
              Saya adalah Frontend Developer & UI/UX Designer dengan pengalaman
              1+ tahun membantu startup dan perusahaan membangun produk digital
              yang tidak hanya indah secara visual, tapi juga berkinerja tinggi.
            </p>
            <p
              className="text-[14px] leading-loose"
              style={{ color: t.textMuted }}
            >
              Latar belakang saya di desain & development memberikan perspektif
              unik — saya bisa menjembatani kebutuhan bisnis dengan solusi
              teknis yang elegan.
            </p>
...
<section id="contact" className="relative z-10 py-28 px-6 md:px-14 max-w-6xl mx-auto">
  ...
  <div className="mb-16" data-aos="fade-up">
    <h2 className="text-[clamp(2rem,4.5vw,3.6rem)] font-bold leading-[1.1] tracking-tight mb-4" style={{ color: t.text }}>
      Mari buat sesuatu{" "}
    ...
    <div className="lg:col-span-2 flex flex-col gap-4" data-aos="fade-right">
      ...
      <div className="flex flex-col gap-2.5">
        {[
          ...
          { name: "GitHub",   label: "GitHub",   value: "HaryoMahendra",             href: "https://github.com/HaryoMahendra",                             accent: dark ? "#d0d7de" : "#24292F" },
        ].map(({ name, label, value, href, accent }, i) => (
          <motion.a
            key={i}
            href={href}
          ...
          >
            ...
            <div className="w-6 h-6 rounded-full flex items-center justify-center shrink-0 opacity-0 group-hover:opacity-100 transition-all duration-200"
      ...
      <div className="grid grid-cols-3 gap-2.5">
        {[
          ...
          <div key={i} className="flex flex-col items-center justify-center py-4 rounded-xl"
        ...
        <form className="flex flex-col gap-4 relative z-10" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap gap-2">
              {["UI/UX Design","Frontend Dev","Freelance","Full-time","Kolaborasi","Lainnya"].map((chip) => (
