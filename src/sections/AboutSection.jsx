      ...
      <div className="grid md:grid-cols-2 gap-16 items-start">
        <div data-aos="fade-right">
          ...
          <p className="text-[15px] leading-loose mb-4" style={{ color: t.textSub }}>
            Saya adalah Frontend Developer & UI/UX Designer dengan pengalaman 1+ tahun membantu startup dan perusahaan membangun produk digital yang tidak hanya indah secara visual, tapi juga berkinerja tinggi.
          </p>
        ...
        <div data-aos="fade-left">
          ...
          <div className="flex justify-center mb-10">
            <div className="relative w-52 h-52">
              ...
              >
                ...
                <p className="text-[13px] font-bold mt-1" style={{ color: t.text }}>Haryo Mahendra</p>
          ...
          <div className="flex flex-col gap-4">
            <p className="text-[11px] uppercase tracking-[0.2em] mb-1 font-semibold" style={{ color: t.textMuted }}>
              Tech Skills
            </p>
            {SKILLS.map((s, i) => (
