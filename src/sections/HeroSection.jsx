    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-14 items-center">
        <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
          <p className="text-[12px] font-semibold mb-2 tracking-[0.2em] uppercase" style={{ color: t.textMuted }}>
            Hi, saya
          </p>
          <h1
          ...
          <p className="text-[15px] leading-relaxed max-w-md mb-10" style={{ color: t.textSub }}>
            1+ tahun membangun website modern & produk digital yang memadukan estetika dan performa tinggi — dari desain Figma hingga kode production.
          </p>
...
/>
            ...
            <div className="flex gap-8 pt-3 mt-1 w-full justify-center" style={{ borderTop: `1px solid ${t.divider}` }}>
              {[{ val: "10+", label: "Projects" }, { val: "5+", label: "Clients" }].map(({ val, label }, i) => (
                <div key={i} className="text-center">
                  <p className="text-[18px] font-bold" style={{ background: "linear-gradient(135deg,#3B82F6,#8B5CF6)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                    {val}
                  </p>
